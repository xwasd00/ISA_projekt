...
\begin{figure}[H]
    \centering
    \scalebox{0.39}{\includegraphics{ssl.png}}
...
\subsection{Obrázky}
\begin{thebibliography}{99}
\bibitem{obr1} AGA, 2018. 0RTT handshake state diagram. [online] Dostupné z: \url{https://labs.portcullis.co.uk/blog/playback-a-tls-1-3-story/#imageclose-6777}
\end{thebibliography}
